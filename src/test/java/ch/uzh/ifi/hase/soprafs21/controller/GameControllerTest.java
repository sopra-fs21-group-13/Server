...
public class GameControllerTest {
    ...
    /*
        @Test
        public void givenGame_addMessage_validInput() throws Exception {
        ...
        @Test
        public void givenGame_addPlayer_validInput() throws Exception {
            ...
            game.setPlaySetId(1L);
            game.setPlayCards(Collections.singletonList(new Card()));
            game.setPlayers(Collections.singletonList(newUser));
            game.setCountDown(false);
            game.setTimer(10L);
